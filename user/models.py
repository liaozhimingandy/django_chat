...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    mobile = models.CharField(null=True, blank=True, help_text='手机号码', max_length=512)
    sex = models.SmallIntegerField(null=False, choices=sex_code, help_text='性别', default=0)
    avatar = models.CharField(null=False, max_length=512, help_text='头像图片')
    user_status = models.BooleanField(null=False, default=False, help_text='用户状态')
    user_type = models.SmallIntegerField(null=False, default=1, help_text='用户类型')
    salt = models.CharField(null=True, help_text='盐', max_length=512)
    password = models.CharField(null=True, help_text='用户密码', max_length=512)
