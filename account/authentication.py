...
from account.common.token import verify_jwt_token
...
class AuthBearer(HttpBearer):
    ...
    def authenticate(self, request, token):
        ...
        # 校验jwt token并解析数据
        grant_type = "client_credential" if request.resolver_match.view_name == "api-3.0:refresh_token" \
            else "access_token"
        ...
        if (request.resolver_match.view_name != "api-3.0:refresh_token"
