...
class Moment(models.Model):
    ...
    user_id = models.CharField(default='', help_text="所属用户id", max_length=1024)
    loc = models.CharField(null=True, blank=True, default='', help_text="位置", max_length=1024)
    ...
    address = models.CharField(max_length=512, null=True, blank=True, help_text='地址名称', default='')
    ...
    poi = models.CharField(max_length=512, null=True, blank=True, help_text='地址POI信息', default='')
