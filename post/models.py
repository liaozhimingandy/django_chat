...
class Post(models.Model):
    ...
    uid = models.CharField(help_text="用户ID", max_length=64, db_comment='用户ID', verbose_name="用户ID")
    from_ip = models.GenericIPAddressField(help_text="来源ip", db_comment="来源ip", verbose_name="用户ID", unpack_ipv4=True)
    ...
    location = models.CharField(null=True, blank=True, help_text="位置", max_length=128,
                                db_comment="位置", verbose_name="位置")
    is_top = models.BooleanField(default=False, help_text='是否置顶', db_comment='是否置顶', db_default=False, verbose_name="是否置顶")
